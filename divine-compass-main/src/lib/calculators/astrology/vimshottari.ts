...
export interface VimshottariDashaResult {
  ...
  degreeElapsedInNakshatra: number;
...
export function getCurrentDasha(
  ...
  let activeMaha: MahadashaPeriod | null = null;
  let activeAntar: AntardashaPeriod | null = null;
  let activePratyantar: PratyantardashaPeriod | null = null;
...
export function calculateVimshottariDasha({
  ...
  const dashaBalanceAtBirth: DashaBalance = {
    years: balanceYears,
...
if (typeof window !== "undefined" || typeof global !== "undefined") {
  try {
    ...
    console.log(
      "=== VIMSHOTTARI DASHA VALIDATION TEST (ARJUN) ===",
      ...
      `${testResult.dashaBalanceAtBirth.years} Years, ${testResult.dashaBalanceAtBirth.months} Months, ${testResult.dashaBalanceAtBirth.days} Days`,
      "\nFirst Mahadasha Period (Starts before birth):",
      formatDashaDate(testResult.mahadashas[0].start), "to", formatDashaDate(testResult.mahadashas[0].end),
