  ...
  return (
    <AppShell title="Vehicle Number" eyebrow="Numerology" showBack>
      ...
      <div
        ...
        style={{ background: "linear-gradient(145deg, #0c1a3a, #0f2555, #081428)" }}
      >
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-widest text-sky-300/60 font-bold mb-0.5">Chaldean Numerology</p>
            <h2 className="font-display text-lg font-bold text-white leading-tight">Vehicle Vibration</h2>
          </div>
        </div>
        <p className="relative z-10 text-xs text-white/50 mt-3 leading-relaxed">
          Every vehicle number carries planetary energy. Discover the cosmic vibration of your registration number.
        </p>
      </div>
