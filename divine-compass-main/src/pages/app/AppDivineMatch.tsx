  ...
  return (
    <AppShell title="Divine Match" eyebrow="Kundali Milan" showBack>
      ...
      <div
        ...
        style={{ background: "linear-gradient(145deg, #1f0010, #3b0020, #1a000f)" }}
      >
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-widest text-rose-300/60 font-bold mb-0.5">Ashtakoot · 36 Gunas</p>
            <h2 className="font-display text-lg font-bold text-white leading-tight">Kundali Milan</h2>
          </div>
        </div>
        <p className="relative z-10 text-xs text-white/50 mt-3 leading-relaxed">
          Ancient Vedic compatibility analysis across 8 sacred dimensions — from nature to destiny alignment.
        </p>
      </div>
