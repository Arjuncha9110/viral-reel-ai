  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        saffron: "bg-gradient-to-r from-primary to-sacred-amber text-primary-foreground shadow-soft hover:shadow-glow-saffron hover:scale-[1.02] active:scale-[0.98]",
        gold: "bg-gradient-to-r from-gold to-gold-light text-foreground shadow-soft hover:shadow-glow-gold hover:scale-[1.02] active:scale-[0.98]",
        maroon: "bg-secondary text-secondary-foreground hover:bg-maroon-light shadow-soft hover:shadow-card active:scale-[0.98]",
        spiritual: "bg-card border-2 border-primary/20 text-foreground hover:border-primary/40 hover:bg-primary/5 shadow-soft",
      },
      size: {
