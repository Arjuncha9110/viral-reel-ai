...
export interface VastuDir {
  ...
  label: string;         // "North", "Northeast", …
  shortLabel: string;    // "N", "NNE", …
  sanskrit: string;      // "Uttara", "Ishanya", …
  lord: string;          // presiding deity
  element: string;       // "Water", "Fire", …
  elementIcon: string;   // emoji
  guna: Guna;
  dosha: string;         // primary vastu dosha concern
  location: string;      // ideal room / placement
  description: string;   // spiritual flavour text
  benefits: string[];
  avoid: string[];
  guidance: string[];
}
...
export const VASTU_DIRECTIONS: VastuDir[] = [
  ...
  },
  {
    ...
    description: "The most sacred corner of any Vastu structure — the portal of divine wisdom. Lord Shiva presides here, infusing the home with spiritual light, intelligence, and health. Any disturbance to this corner creates significant energetic imbalance.",
  ...
  },
  {
    ...
    description: "Touched by Surya's first rays, ENE carries the rejuvenating energy of dawn. It supports physical health and the purification rituals of morning — bathing, yoga, and prayer.",
  ...
  },
  {
    ...
    description: "Indra, king of the celestials, governs the East — the direction of the rising sun and social glory. An open, welcoming East draws prosperity, social harmony, and the blessings of light into the dwelling.",
  ...
  },
  {
    ...
    description: "A transitional zone between the airy grace of East and the fire of the Southeast. The fire element begins to assert itself here. Electrical equipment finds a harmonious home in this zone.",
  ...
  },
  {
    ...
    description: "Agni, the sacred fire deity, rules the Southeast with transformative intensity. The kitchen belongs here — cooking in any other direction can create Agni dosha, leading to health and financial imbalances.",
  ...
  },
  {
    ...
    description: "Where fire meets the heavy influence of Yama, SSE is a dense and weighty zone. It is best used for solid storage, heavy equipment, or left minimally active. Avoid all dwelling spaces here.",
  ...
  },
  {
    ...
    description: "The domain of Yama, god of dharmic order and transition, the South carries the heaviness of earth and the weight of karmic balance. A solid southern boundary protects the home from Yama's direct gaze.",
  ...
  },
  {
    ...
    description: "Between the forces of Yama and Niruti, SSW carries the densest, most challenging energy in the Vastu chart. It must be anchored with weight and kept free from any active living function.",
  ...
  },
  {
    ...
    description: "Ruled by Niruti, the lord of dissolution, the Southwest is the most powerful and potentially disruptive corner. Its dense earth energy must be dominated by the head of the household sleeping here. An empty or misused SW corner leads to financial loss, illness, and loss of authority.",
  ...
  },
  {
    ...
    description: "A transitional zone where Nairutya's heaviness begins to soften into Varuna's water energy. Still dense but less severe than the SW itself. Use for secondary storage or minor utility rooms.",
  ...
  },
  {
    ...
    description: "Varuna, god of cosmic order and water, governs the West with a promise of steady material gains and growth. The West nourishes children's learning, prosperity, and family dining.",
  ...
  },
  {
    ...
    description: "Between Varuna's watery gains and Vayu's airy movement, WNW carries a light, transient energy. It is best suited for spaces where people come and go — guest rooms, passages, or light storage.",
  ...
  },
  {
    ...
    description: "Ruled by Vayu, the wind god, the Northwest governs movement, relationships, and external support. It governs how the outside world supports you — guests, business associates, and social networks. Daughters of the household are said to benefit from a northwest bedroom.",
  ...
  },
  {
    ...
    description: "Bridging Vayu's movement and Kubera's prosperity, NNW is a gentle transition zone carrying a softly sattvic quality. It supports light activity and can house minor study or sitting areas.",
...
/** Derive the current Vastu direction from a compass heading (0–360°) */
export function getVastuDir(heading: number): VastuDir {
  const h = ((heading % 360) + 360) % 360;
  // Each segment spans 22.5°; offset by half a segment so each direction is centred on its degree
